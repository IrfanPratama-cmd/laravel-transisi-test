...
@section('table')
    <div class="row">
        <div class="col-md-10">
            ...
            <a class="btn btn-danger" href="/employees-pdf/{{$param->id}}"> PDF</a>
            <a class="btn btn-success" href="/employees-excel/{{$param->id}}"> Excel</a>
        </div>
        <div class="col-md-2">
            <div class="btn-group">
                <button type="button" style="width: 190px" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  Filter Company
                </button>
